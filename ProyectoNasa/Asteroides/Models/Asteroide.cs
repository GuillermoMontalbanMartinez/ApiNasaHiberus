namespace Asteroides.Models
{
        ...
        public partial class Asteroide
        {
            public static Asteroide FromJson(string json) => JsonConvert.DeserializeObject<Asteroide>(json, Asteroides.Models.Converter.Settings);
        }

        public static class Serialize
        {
            public static string ToJson(this Asteroide self) => JsonConvert.SerializeObject(self, Asteroides.Models.Converter.Settings);
        }
